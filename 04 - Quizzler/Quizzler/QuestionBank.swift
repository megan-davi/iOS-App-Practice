...
class QuestionBank {
    ...
    init() {
        ...
        list.append(Question(text: "Basco pisses himself with the doorbell rings.", correctAnswer: true))
        ...
        list.append(Question(text: "Last question: what is 2 + 2?", correctAnswer: false))
    }
}
